...
## Project Structure
    ...
    ├── testapiautoconnect_100278  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_100278`
...
2. Clone this repo and `cd testapiautoconnect_100278`
